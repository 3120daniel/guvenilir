            ...
            <div>
                <div class="grid lg:grid-cols-2 md:grid-cols-2 items-center gap-4">
                    ...
                    <form class="max-w-xl w-full p-6 mx-auto">
                        <div class="mb-12">
                            <h1 class="text-slate-900 text-4xl font-bold">Sign in</h1>
                            <p class="text-slate-600 text-sm mt-6">Don't have an account <a href="javascript:void(0);" class="text-blue-600 font-medium hover:underline ml-1 whitespace-nowrap">Register here</a></p>
                        </div>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="relative flex items-center">
                                    <input name="email" type="text" required class="w-full text-sm text-slate-900 border-b border-slate-300 focus:border-blue-600 pr-8 px-2 py-3 outline-none" placeholder="Enter email" />
                            ...
                            <div>
                                ...
                                <div class="relative flex items-center">
                                    <input name="password" type="password" required class="w-full text-sm text-slate-900 border-b border-slate-300 focus:border-blue-600 pr-8 px-2 py-3 outline-none" placeholder="Enter password" />
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-4">
                                ...
                                <div>
                                    <a href="jajvascript:void(0);" class="text-blue-600 font-medium text-sm hover:underline">
                                        Forgot Password?
                                    </a>
                                </div>
                            </div>
                        ...
                        <button type="button" class="w-full flex items-center justify-center gap-4 py-2 px-4 text-[15px] font-medium tracking-wide text-slate-900 border border-slate-300 rounded-md bg-transparent hover:bg-slate-50 focus:outline-none cursor-pointer">
