...
export default function GoldInvestments() {
    return (
        <div>
            <Banner title="Our Services" desc="Gold Investments" />
            <div className='pt-20'>
                {/* Title */}
                <div className='flex flex-col justify-center items-center mb-10'>
                    <p className='text-3xl font-bold'>Gold Investments</p>
                ...
                <div className='max-w-4xl mx-auto mb-10'>
                    ...
                    <div className='flex justify-center mt-10'>
                        <div className='flex items-start gap-4 sm:gap-6'>
                            ...
                            <div>
                                <p className='text-lg sm:text-2xl font-semibold mb-3'>Trading Forex on Güvenilir-varlıklar</p>
