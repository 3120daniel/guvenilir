          ...
          <div>
            ...
            <div className='flex justify-center mt-10'>
              <div className='flex items-start gap-4 sm:gap-6'>
                ...
                <div>
                  <p className='text-lg sm:text-2xl font-semibold mb-3'>
                    Why trade Cryptocurrencies with Güvenilir-varlıklar?
                  </p>
                  <p>
                    Cryptocurrencies could potentially be the currency of the future with more people gaining interest and price value going up. Güvenilir-varlıklar offers competitive spreads, with no commissions charged on transactions making it more profitable. When trading with Güvenilir-varlıklar you are trading on the price changes of the digital coin, and not physically purchasing it. Trading with Güvenilir-varlıklar ensures that you will trade with a 100% reputable broker.
                  </p>
                </div>
              </div>
            </div>
