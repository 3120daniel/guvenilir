                ...
                <div className='space-y-6 w-full text-white'>
                    ...
                    {[
                        ...
                        },
                        {
                            ...
                            <div className='flex items-center gap-6 border border-amber-400 p-6 rounded-xl max-w-xl'>
                                <div className='bg-amber-400 shrink-0 h-12 w-12 rounded-full flex justify-center items-center font-bold text-xl'>
                                    {i + 1}
                                </div>
                                <div className=''>
